    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('images/no-image.png' )}}" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-orange-500 dark:text-white">SKshop</span>
            </a>
    ...
    <footer class="bg-blue-900 dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="{{ asset('images/no-image.png' )}}" class="h-8 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-white">SKshop</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-blue-500 uppercase dark:text-white">Resources</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-blue-500 uppercase dark:text-white">Follow us</h2>
                        <ul class="text-gray-200 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-blue-500 uppercase dark:text-white">Legal</h2>
                        <ul class="text-gray-200 dark:text-gray-400 font-medium">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-200 sm:text-center dark:text-gray-400">© 2023 <a
                        href="https://flowbite.com/" class="hover:underline">SKshop™</a>. All Rights Reserved.
                </span>
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="#" class="text-gray-200 hover:text-gray-900 dark:hover:text-white ms-5">
                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
